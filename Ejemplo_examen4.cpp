...
int main(){
    float h,w,Wid,oro;
    char complexio,sexe;
    cout<<"Indica la teva alcada (cm), el teu pes (kg), la teva complexio (R,P,N) i el teu sexe (H,D): "<<endl;
    cin>>h>>w>>complexio>>sexe;
    if (1.12<(h/w) && (h/w)<3.80 && (sexe=='D'||sexe=='H') && (complexio=='P'||complexio=='N'||complexio=='R')){
        if (sexe=='D'){
